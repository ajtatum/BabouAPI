...
namespace AJT.API.Web.Areas.API
{
    ...
    public class UrlShortenerController : ControllerBase
    {
        ...
        /// <param name="domain">The domain to use. BabouIo links to https://babou.io/ and MrvlCo links to https://mrvl.co/. Default is BabouIo</param>
        ...
        public async Task<IActionResult> Post([Required][FromHeader] string longUrl, [Optional][FromHeader] Domains? domain, [Optional][FromHeader] string token)
        {
            try
            {
                ...
                {
                    return new BadRequestObjectResult("Error finding user with the AuthKey used.");
                }
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError(ex, "UrlShortenerController: Error creating short url for {LongUrl}, {Domain} and {Token}", longUrl, domainString, token);
